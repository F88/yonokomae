...
- **Catalog Package**: `@yonokomae/catalog` (Enumerations / Constants / Domain Catalog)
- **Type Packages**: `@yonokomae/types` (Types), `@yonokomae/schema` (Zod Schemas)
- **Data Packages**:
...
- **Mock API**: `mock-api/` - Local development stub server
