...
const battle = {
  ...
  scenario:
    'YONOでは1928に繊維工業が拡大(松本産業など)。2020には(さいたま市全体で)第3次産業の就業者が8割超で、2001の合併/さいたま新都心開発と整合的。KOMAEは昭和期に農業・養蚕が中心で、2020の就業構成は第1次296、第2次5,045、第3次26,818。鉄道/路線(YONO: 駅4/路線3、KOMAE: 駅2/路線1)は接続規模の差を示す。',
  komae: {
  ...
  yono: {
    ...
    subtitle: '都市サービスの集中',
    description:
      '1928の繊維工業拡大。2020には(さいたま市全体で)第3次産業が8割超。2001以降のさいたま新都心開発が成長を加速。鉄道: 駅4、路線3。地区別GDPは非公開。',
    power: 59,
  },
  provenance: [
    {
