  ...
  describe('get method', () => {
    ...
    describe('Error handling', () => {
      ...
      it('propagates network errors', async () => {
        ...
        await expect(client.get('/network-fail')).rejects.toThrow('Network failure');
        await expect(client.get('/network-fail')).rejects.not.toThrow(HttpError);
      });
      ...
      it('handles AbortError correctly', async () => {
        ...
        await expect(client.get('/aborted', controller.signal)).rejects.toThrow('The operation was aborted');
      });
    });
