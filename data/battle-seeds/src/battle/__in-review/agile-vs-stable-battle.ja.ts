...
const battle = {
  ...
  narrative: {
    overview:
      '独立を維持した狛江市の機動的な行政運営と、' +
      '合併で規模のメリットを得たさいたま市(旧与野市)の安定的な行政運営が対決する。',
    scenario:
  ...
  komae: {
    ...
    description:
      '独立した小規模自治体の強みを活かし、創業支援事業やDX戦略を推進。' +
      'オンライン申請の導入など、時代に合わせた小回りの利く施策で、市民生活の利便性向上を目指している。',
    power: 82,
  },
  yono: {
    ...
    description:
      '政令指定都市という大規模な行政体となり、広域行政を効率的かつ安定的に運営するさいたま市。' +
      '市民に均一で安定したサービスを提供することで、盤石な行政運営を誇る。',
    power: 86,
  },
  provenance: [
    {
