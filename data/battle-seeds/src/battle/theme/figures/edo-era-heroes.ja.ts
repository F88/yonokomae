...
const battle = {
  ...
  narrative: {
    overview:
      '江戸時代、異なる才能で世を動かした二人の偉人が、故郷の誇りをかけて激突する。' +
      '武士の誉れか、学問の道か、どちらが歴史に名を刻んだか。',
    scenario:
  ...
  komae: {
    ...
    description:
      '川崎定孝。' +
      '多摩川の治水事業に生涯を捧げ、こまえの地を洪水から守った技術者。' +
      '彼の探求心は、こまえの市民が持つ独自の技術開発の精神の源流となっている。',
    power: 60,
  },
  yono: {
    ...
    description:
      '大石良雄。' +
      '中山道整備に貢献した人物とされ、忠義と知略を併せ持つ。' +
      'その優れた判断力は、よのが誇る外交と情報戦の精神の礎となった。',
    power: 60,
  },
  provenance: [
    {
