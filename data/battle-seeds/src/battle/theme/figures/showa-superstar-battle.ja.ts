...
const battle = {
  ...
  narrative: {
    overview:
      '時代を築いた昭和の大スターたちが、それぞれの故郷の誇りをかけて激突する。' +
      '反骨のロックンロールか、知性の朗読か。' +
      'どちらが勝利を掴むか。',
    scenario:
      'よのは、伝説のロック・スター、萩原健一を擁し、その反骨精神と型破りな生き方で観客を魅了する。' +
      '一方、こまえは、不世出の女優、紺野美沙子を代表とし、朗読や知性的な魅力で静かに人々を惹きつける。' +
      '熱狂で勝るよのか、深みと知性で勝るこまえか。' +
      '世代を超えた伝説のスターたちが、故郷の名誉をかけて戦う。',
  },
  komae: {
    ...
    description:
      '紺野美沙子。' +
      'こまえ市出身の女優で、朗読や国際協力活動でも知られる。' +
      '彼女の持つ知的な魅力は、こまえの市民が誇る精神の豊かさそのものである。',
    power: 69,
  },
  yono: {
    ...
    description:
      '萩原健一。' +
      'よの市(現さいたま市中央区)出身の伝説的ロック・スター。' +
      'その型破りで個性的な生き方は、よのの持つ先進性と知性を象徴している。' +
      '新都心のライトに最も似合う男、それが彼の正体だ。',
    power: 69,
  },
  provenance: [
    {
