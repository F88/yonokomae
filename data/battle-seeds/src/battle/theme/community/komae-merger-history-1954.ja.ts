...
const battle = {
  ...
  komae: {
    ...
    description:
      ...
      'この街の真面目さも好きだけど、あの日はただただ、ため息と苦笑い。',
    power: 62,
  },
  yono: {
  ...
  provenance: [
    ...
    {
      label: '無法地帯を行く : 狛江町現地レポート (レポートシリーズ ; 第1集)',
      url: 'https://ndlsearch.ndl.go.jp/books/R100000002-I000001334274',
      note: '無法地帯を行く : 狛江町現地レポート (レポートシリーズ ; 第1集) | NDLサーチ | 国立国会図書館',
    },
    {
      label: '当時を知る多摩川のカワウソのコメント',
      note: '「人の議論はむずかしい。けれど、その日ばかりは川の石ころだって“印がないと転がらない”顔をしていたよ。」',
    },
    {
      label: '多摩川の対岸の井戸端会議',
      note: '川の向こうから眺める混乱。遠いようで近い、近いようで遠い——まさに“対岸”の珍事。',
    },
  ],
  status: 'success',
} satisfies Battle;
