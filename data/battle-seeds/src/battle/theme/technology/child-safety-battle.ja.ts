...
const battle = {
  ...
  narrative: {
    overview:
      'よのはAIとドローンで子供の安全を完璧に管理する。' +
      'しかし、こまえは住民同士の見守り活動こそが真の安全だと主張する。' +
      'テクノロジーによる完璧な管理か、人の温もりによる見守りか、未来の安全の形が問われる。',
    scenario:
  ...
  komae: {
    ...
    subtitle: '人の目と声かけが一番',
    description:
      '地域の老人会やPTAが中心となり、登下校の時間に子供たちに声をかける活動。' +
      'AIにはできない、人の温もりとコミュニティの絆で子供たちの安全と心を育む。',
    power: 80,
  },
  yono: {
    ...
    description:
      '最新のAI顔認証システムと監視ドローンを駆使し、24時間365日子供たちを見守る。' +
      '犯罪や事故を未然に防ぐ完璧な安全を提供するが、その管理は時に息苦しさも生む。',
    power: 80,
  },
  provenance: [
    {
