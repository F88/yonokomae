...
const battle = {
  ...
  narrative: {
    ...
    scenario:
      'よのには、天体の運行を精密に計算し未来を予測する巨大な天文盤『アストロラーベ』が存在した。' +
      'これは星々の知識を集積した疑似AIであり、神官たちはその神託によって日食や干ばつを予言し、民を災厄から守った。' +
      '完璧な予測は、よのに絶対的な秩序と安定をもたらした。' +
      '対するこまえの民は、恵みと脅威をもたらす多摩川そのものを神と崇めた。' +
      '彼らは川の氾濫で祭壇が流されるたびに、氏族で力を合わせ、より強固な祭壇を自らの手で築き直した。' +
      'その共同作業こそが、彼らの結束の源泉だった。' +
      '星が示す絶対の真実か、大地と共に生きる不確かな絆か。' +
      '古代の二つの信仰が、民の未来を賭けて対峙する。',
  },
  komae: {
