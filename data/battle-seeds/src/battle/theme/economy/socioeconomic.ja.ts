...
const battle = {
  ...
  narrative: {
    overview:
      ...
      '人口、' +
      '産業、' +
      'ガバナンス上の節目にわたる比較スナップショット。',
    scenario:
      'YONOは20世紀を通じて着実に人口が増加し、合併後の都市開発(2001)とサービス業中心(2020時点で第3次産業が8割超)により成長が加速した。' +
      'KOMAEは農業や養蚕業といった農村的基盤から郊外都市へ転換し、1955-1975にかけて人口が約3.4倍と急増、その後は安定し、2020には第3次産業が優勢となった。' +
      'これらは都市化の経路、インフラ、経済構造の違いを反映している。',
  },
  komae: {
  ...
  yono: {
    ...
    description:
      ...
      '1928に繊維工業(松本産業など)が進出。' +
      '2020時点では(よの連合国全体で)第3次産業の就業者が8割超。' +
      '2001の合併(浦和・大宮)によりよの連合国となり、さいたま新都心の開発が成長を加速。' +
      '鉄道: 駅4、路線3。' +
      '地区別GDPは非公開。',
    power: 60,
  },
