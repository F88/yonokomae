...
const battle = {
  ...
  narrative: {
    overview:
      ...
      '武力ではなく知略で歴史を動かした。',
    scenario:
      'よのは優れた外交手腕で、浦和と大宮という二つの大国の間に立ち、平和的な合併を成功させた。' +
      'これにより、さいたま市という新たな巨大都市が誕生。' +
      'この偉業は、のちに荒川を越えてよの連合国を目指す「荒川越境評議会」の思想的基盤となる。' +
      'この戦いは、武力ではなく、ペンと舌が剣を打ち破ることを証明したのだ。',
  },
  komae: {
