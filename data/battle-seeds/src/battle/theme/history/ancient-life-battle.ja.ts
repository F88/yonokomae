...
const battle = {
  ...
  narrative: {
    overview:
      '縄文時代と弥生時代、それぞれの生活様式を代表する二つの文化が激突。' +
      '狩猟採集か、それとも農耕か。' +
      'どちらがより優れた文明を築き、現代のよの・こまえの精神の源流となったか。',
    scenario:
  ...
  komae: {
    ...
    description:
      '米作りを通じて定住生活を確立。' +
      '外来の文化を取り入れつつ、強固なコミュニティを築き上げた弥生人の末裔である。',
    power: 50,
  },
  yono: {
    ...
    subtitle: '自然と調和した縄文人',
    description:
      '自然の恵みを享受し、狩猟採集で生きた縄文人の末裔。' +
      'その柔軟な知性は、時代の変化に適応するよのの外交戦略の原点である。',
    power: 50,
  },
  provenance: [
    {
