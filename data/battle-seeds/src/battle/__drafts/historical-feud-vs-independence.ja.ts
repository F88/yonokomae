...
const battle = {
  ...
  narrative: {
    overview:
      '長年にわたる浦和と大宮の確執を乗り越えるため合併を選択した与野市と、' +
      '隣接する自治体との合併構想を拒否し、' +
      '新たな歴史を築くことを選んだ狛江市が対決する。',
    scenario:
  ...
  komae: {
    ...
    description:
      '隣接する自治体との合併構想を拒否し、過去のしがらみに縛られることなく、独立した「狛江市」としての歴史を歩み続けている。' +
      'これは、独自のアイデンティティを確立するための明確な選択であった。',
    power: 83,
  },
  yono: {
    ...
    description:
      '長年にわたる浦和と大宮の主導権争いの狭間にあった与野市が、合併を通じて両市の対立を融和させ、新たな大都市を誕生させた。' +
      'これは、複雑な歴史的背景を乗り越えた統合の象徴だ。',
    power: 88,
  },
  provenance: [
    {
