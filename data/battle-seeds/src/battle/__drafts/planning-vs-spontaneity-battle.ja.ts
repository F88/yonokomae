...
const battle = {
  ...
  narrative: {
    ...
    scenario:
      '与野市は、大宮市・浦和市との合併において、埼玉新都心という大規模開発を推進。これは、行政が主導し、巨大な都市インフラを計画的に構築することで、都市の将来を切り開くという思想だ。一方、狛江市は「水と緑のまち」という将来像を掲げ、多摩川を中心とした市民参加型のイベントや、地域ボランティアによるまちづくりを重視している。これは、計画的な開発よりも、市民の自発的な活動や自然の力を活かし、都市を自然に熟成させていくという思想だ。果たして、トップダウンの壮大な計画と、ボトムアップの自然な成長、どちらがより市民にとって幸福な都市を生み出すのか。',
  },
  komae: {
