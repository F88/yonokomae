...
const battle = {
  ...
  narrative: {
    overview:
      '埼玉新都心という計画的な開発を主導した旧与野市と、市民参加型のイベントや自然を活かしたまちづくりを重視する狛江市。' +
      '都市の発展に対する思想が対決する。',
    scenario:
  ...
  komae: {
    ...
    description:
      '多摩川いかだレースや花火大会など、市民が主体となって開催されるイベントが盛んな狛江市。' +
      'これは、行政主導の計画的な開発に頼らず、市民の力でまちを熟成させていくことを重視する姿勢を象徴している。',
    power: 84,
  },
  yono: {
    ...
    description:
      '合併を決定づけた要因の一つである埼玉新都心開発。' +
      'これは、巨大な行政機関や商業施設を計画的に配置することで、都市のあり方を一変させる、トップダウン型の都市計画を象徴している。',
    power: 89,
  },
  provenance: [
    {
