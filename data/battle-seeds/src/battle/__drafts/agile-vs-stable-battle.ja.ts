...
const battle = {
  ...
  narrative: {
    ...
    scenario:
      '政令指定都市となり、大規模なインフラと広域行政を盤石な「守り」の基盤とするさいたま市。多くの市民に安定したサービスを画一的に提供することで、大規模化のメリットを活かしている。一方、狛江市は、創業支援事業やDX戦略など、小規模自治体ならではの小回りの利く「攻め」の施策を積極的に推進している。これは、既存のサービスを守りつつ、新しい価値を素早く創出することを目指す行政戦略だ。果たして、規模の安定性を重視する「守り」の行政と、機動性を活かした「攻め」の行政、どちらが時代の変化に柔軟に対応できるのか。',
  },
  komae: {
