...
const battle = {
  ...
  narrative: {
    overview:
      ...
      '一方、与野市では市民による住民投票が実施されず、政治的判断が優先された。' +
      '市民の意思表示のあり方が問われる対決。',
    scenario:
  ...
  komae: {
    ...
    description:
      '合併に無関心な市民が多い中で、当時の首長が「狛江のアイデンティティを失う」として明確に反対の立場を取り、独立を主導した。' +
      'これは、強力なリーダーシップが地域の運命を決定づけた象徴だ。',
    power: 80,
  },
  yono: {
    ...
    description:
      '浦和、大宮、与野の合併において、住民投票は実施されず、行政が主導して合併が決定された。' +
      'これは、市民の直接的な意思表示よりも、政治的・構造的な判断が優先された経緯を象徴している。',
    power: 89,
  },
  provenance: [
    {
